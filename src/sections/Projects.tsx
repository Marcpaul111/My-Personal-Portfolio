import darkSaasLandingPage from "@/assets/images/project3.png";
import lightSaasLandingPage from "@/assets/images/project1.png";
import aiStartupLandingPage from "@/assets/images/project2.png";
                ...
                <div className="lg:pb-16">
                  ...
                  <ul className="flex flex-col gap-4 lg:gap-8 mt-4 md:mt-5 ">
                    {project.results.map((result) => (
                      <li key={result.title} className="flex gap-2 item-center text-sm md:text-base  text-white/50">
